    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <?php echo $__env->make('admin.widgets.card', [
                    'class'=>'primary',
                    'class_icon'=>'fa fa-comments fa-5x',
                    'total'=>'105',
            ...
            <div class="col-lg-3 col-md-6">
                <?php echo $__env->make('admin.widgets.card',[
                    'class'=>'yellow',
                    'class_icon'=>'fa fa-shopping-cart fa-5x',
                    'total'=>'15',
                    'text'=>'Nuevas Ventas'
                    ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <?php echo $__env->make('admin.widgets.card',[
                    'class'=>'red',
                    'class_icon'=>'fa fa-support fa-5x',
                    'total'=>'158',
                    'text'=>'Nuevos Tickets!'
                    ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="row">
            <div class="col-lg-8">
                <?php $__env->startComponent('admin.widgets.panel'); ?>
                    <?php $__env->slot('panelTitle', 'Responsive Timeline'); ?>
            ...
            <div class="col-lg-4">
                ...
                <?php $__env->startComponent('admin.widgets.panel'); ?>
                    <?php $__env->slot('panelTitle', 'Notification Panel'); ?>
                    <?php $__env->slot('panelBody'); ?>
